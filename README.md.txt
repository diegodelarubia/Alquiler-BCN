...
Los datos utilizados proceden del portal Barcelona Data (Open Data BCN) e incluyen:
...
Corrección de la columna Tipus de territori, identificando correctamente las categorías Barri y Districte que aparecían entre paréntesis en el nombre del territorio.
...
De forma adicional, se incluyen los niveles agregados (comunidad autónoma y ámbito funcional territorial) únicamente como referencia contextual.
...
Los resultados muestran una correlación positiva entre ambas variables: los barrios con mayor renta tienden a presentar precios de alquiler más elevados.

Sin embargo, también se observan casos donde el precio del alquiler es alto en relación con la renta media, lo que sugiere la influencia de factores adicionales como la localización, la oferta de vivienda o la presión de la demanda.

📉 6. Evolución comparada de renta y alquiler
...
El análisis muestra un aumento progresivo del esfuerzo económico de los hogares, lo que refleja una creciente presión del mercado del alquiler en Barcelona.

📍 8. Análisis de barrios extremos
...
Los resultados muestran que existe una relación clara entre renta y precios del alquiler, aunque también se observan diferencias importantes entre territorios.

En conjunto, el análisis sugiere que el precio del alquiler ha aumentado más rápido que la renta de los hogares, incrementando el esfuerzo económico necesario para acceder a una vivienda y evidenciando desigualdades en el acceso a la vivienda dentro de la ciudad.
